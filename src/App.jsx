...
function obtenerNombreCorto(nombre) {
  return nombre?.split(" ")?.[0]?.toLowerCase()?.replace(/^./, (letra) => letra.toUpperCase()) || "Jonathan";
}
    ...
    <main className="dashboard-shell">
      <aside className="sidebar">
        ...
        <nav className="side-nav" aria-label="Navegación principal">
          ...
          <a href="#iva">◔ IVA</a>
          <a href="#bps">☷ BPS / FONASA</a>
          <a href="#anep">▤ ANEP</a>
          <a href="#backup">◉ Backup & Datos</a>
          <a href="#obligaciones">☰ Obligaciones</a>
        </nav>
      ...
      <section className="main-panel" id="dashboard">
        <header className="topbar">
          ...
          <div className="quick-status">
            <button className="status-chip success" type="button" onClick={revisarAlertas}>
              ✓ Sistema activo
            </button>
            <button className="status-chip primary" type="button" onClick={probarTelegram}>
              ✈ Telegram conectado
            </button>
          </div>
        </header>
        ...
        <section className="content-grid">
          <section className="module-card certificados-card" id="certificados">
            <div className="module-title">
              <div className="module-icon purple-soft">▣</div>
              <div>
                <h2>Certificados</h2>
            ...
            <button className="button-light" onClick={() => abrirLink(empresa.links.dgiCertificado)}>
          ...
          <section className="module-card obligaciones-card" id="obligaciones">
            <div className="module-title">
              <div className="module-icon gray-soft">☰</div>
              <div>
                ...
                return (
                  <article key={item.id} className="obligacion">
                    <div>
                      ...
                      <p>
                        <strong>Vencimiento:</strong> {formatearFecha(item.vencimiento)}
                      </p>
        ...
        <footer>
          <p>
            Las fechas tributarias deben verificarse siempre contra fuentes oficiales de DGI, BPS y FONASA.
          </p>
        </footer>
      </section>
    </main>
